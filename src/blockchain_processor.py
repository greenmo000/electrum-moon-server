...
class BlockchainProcessor(Processor):
    ...
    def do_catch_up(self):
        ...
        while not self.shared.stopped():
            ...
            if self.shared.paused():
                print_log("mooncoind is responding")
                self.shared.unpause()
            time.sleep(10)
    ...
    def bitcoind(self, method, params=[]):
        ...
        while True:
            try:
                ...
                print_log("cannot reach mooncoind...")
                self.shared.pause()
                time.sleep(10)
    ...
    def hash_header(self, header):
        # OK mooncoin todo: remove auxpow offsets before hashing
    ...
    def read_chunk(self, index):
        # mooncoin todo: include auxpow data in chunk...
        with open(self.headers_filename, 'rb') as f:
    ...
    def write_header(self, header, sync=True):
        ...
        # mooncoin todo: not sure why 40*100 was chosen... half of 80?
    ...
    def flush_headers(self):
        ...
        with open(self.auxpows_filename, 'a+') as f:
            # mooncoin todo: always write auxpow data at end of file?
    ...
    # mooncoin todo: not sure if the 80 here is related to block header
    ...
    def getfullblock(self, block_hash):
        ...
        try:
            ...
            logger.error("mooncoind error (getfullblock)",exc_info=True)
            self.shared.stop()
        ...
        for ir in r:
            if ir['error'] is not None:
                self.shared.stop()
                print_log("Error: make sure you run mooncoind with txindex=1; use -reindex if needed.")
